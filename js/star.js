...
function setLoadMessage(input) {
    console.log(input);
}
function loadStarSurfaceTextures(){
	if( sunTexture === undefined ){
		sunTexture = THREE.TextureLoader( "images/sun_surface.png" );
	}

	if( sunColorLookupTexture === undefined ){
		sunColorLookupTexture = THREE.TextureLoader( "images/star_colorshift.png" );
	}

	if( solarflareTexture === undefined ){
		solarflareTexture = THREE.TextureLoader( "images/solarflare.png", undefined, setLoadMessage("Distributing solar flares")	 );
	}

	if( sunHaloTexture === undefined ){
		sunHaloTexture = THREE.TextureLoader( "images/sun_halo.png", undefined, setLoadMessage("Calculating coronal mass") );
	}

	if( sunHaloColorTexture === undefined ){
		sunHaloColorTexture = THREE.TextureLoader( "images/halo_colorshift.png" );
	}

	if( sunCoronaTexture === undefined ){
		sunCoronaTexture = THREE.TextureLoader( "images/corona.png", undefined, setLoadMessage("Projecting coronal ejecta") );
	}
}
